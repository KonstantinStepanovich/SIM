...
**
** Created: Wed 23. Nov 02:24:04 2011
...
const QMetaObject DelegateValue::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_SpinBoxDelegate,
      qt_meta_data_SpinBoxDelegate, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DelegateValue::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *DelegateValue::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *DelegateValue::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SpinBoxDelegate))
        return static_cast<void*>(const_cast< DelegateValue*>(this));
    return QItemDelegate::qt_metacast(_clname);
}

int DelegateValue::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
